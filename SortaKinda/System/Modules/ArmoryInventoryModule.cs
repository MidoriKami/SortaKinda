...
public class ArmoryInventoryModule : InventoryModuleBase
{
    ...
    public override IModuleConfig ModuleConfig { get; set; } = new ArmoryModuleConfig();

    private InventoryType selectedTab = InventoryType.ArmoryMainHand;

    private Dictionary<InventoryType, InventoryGrid> armoryTabs = null!;
    ...
    protected override void LoadModule()
    {
        ...
        armoryTabs = new Dictionary<InventoryType, InventoryGrid>
        {
